...
import { Shield, ArrowLeft, Search, Calendar, Clock, User, Tag, TrendingUp, BookOpen, Eye } from "lucide-react";
import { Link } from "react-router-dom";

export default function Blog() {
  const featuredPost = {
    title: "The Future of OT Security: Protecting Industrial Control Systems",
    excerpt: "As operational technology becomes increasingly connected, the attack surface expands dramatically. Here's how to implement robust security frameworks for industrial environments.",
  ...
  const recentPosts = [
    {
      ...
      excerpt: "A practical guide to deploying zero trust architecture in OT environments without disrupting operations.",
      author: "Zaki Mohammed",
    ...
    },
    {
      ...
      excerpt: "Understanding adversary tactics and techniques specific to industrial control systems using the MITRE framework.",
      author: "Zaki Mohammed", 
    ...
    },
    {
      ...
      excerpt: "Essential strategies for creating security operations centers that can effectively monitor and respond to modern threats.",
      author: "Zaki Mohammed",
    ...
    },
    {
      ...
      excerpt: "Separating fact from fiction in AI security tools and implementing practical machine learning solutions for threat detection.",
      author: "Zaki Mohammed",
    ...
    },
    {
      ...
      excerpt: "Creating effective automated response workflows that reduce incident response time while maintaining security effectiveness.",
      author: "Zaki Mohammed",
    ...
    },
    {
      ...
      excerpt: "Comprehensive guide to maintaining security compliance in AWS environments with practical implementation strategies.",
      author: "Zaki Mohammed",
  ...
  const popularTags = [
    "cybersecurity", "threat-detection", "industrial-security", "mitre-attack", 
    "zero-trust", "soc", "incident-response", "ai-security", "compliance", "risk-management"
  ];
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
                In-depth analysis, practical guides, and emerging trends in cybersecurity, 
                operational technology protection, and threat intelligence.
              </p>
            </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold mb-8 cyber-text">Featured Article</h2>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              {/* Categories */}
              <div>
                <h3 className="text-xl font-bold mb-6 cyber-text">Browse by Category</h3>
                <div className="grid grid-cols-2 gap-4">
                  {categories.map((category, index) => (
                    <Card key={index} className="cyber-card cyber-hover p-4 text-center">
              ...
              {/* Popular Tags */}
              <div>
                <h3 className="text-xl font-bold mb-6 cyber-text">Popular Topics</h3>
